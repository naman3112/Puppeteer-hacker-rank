...
browserPromise
  ...
  .then(function (data) {
    let problemSolvedPromise = solveQuestion(
      "https://www.hackerrank.com" + data[0]
    );
    ...
    tab
      ...
      .then(function (data) {
        return tab
          .goto(problemUrl)
          .then(function () {
            let checkboxWaitPromise = tab.waitForSelector(
          ...
          .then(function () {
            let editorClickPromise = tab.click(
